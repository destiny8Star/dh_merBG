            ...
            <div class="main-content" id="main-content" :style="{height: (getWinHeight-60)+'px'}">
                <div class="main-feature">
                    <div class="main-inner">
                        <h1 class="ly-title-one" style="margin-bottom: 40px">编辑门店</h1>
                        <div class="form-list">
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            getDetail(){
                this.$axios.post('/mer/store/detail',{'id':this.shopId}).then(res => {
                    console.log(res);
                    if (res.data.code === this.$webConfig.httpSuccessStatus) {
                        // this.codeList = res.data.data;
                        this.form = res.data.data;
                        this.form.imgUrl = res.data.data.store_logo
                    }else {
                        this.$message(res.data.message);
                    }
                })
            ...
            handleAvatarSuccess(res, file) {
                ...
                this.form.imgUrl = this.$webConfig.apiHosts + this.qn.key;
            },
            /**
             *  上传前判断
             */
        ...
        mounted() {
            ...
            if(this.$route.query.shopId){
                this.shopId = this.form.id = this.$route.query.shopId;
            }
        //    获取门店详情
            this.getDetail();
        }
