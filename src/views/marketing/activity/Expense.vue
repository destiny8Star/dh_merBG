<template>
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            <div class="third-nav">
                <div class="third-nav-t">创建消费送活动</div>
            </div>
                    ...
                    <div class="main-inner">
                        <div class="form-list">
                            <el-form label-position="left" ref="form" :model="form" label-width="100px" :rules="rules">
                                ...
                                <el-form-item label="消费送规则" prop="rule_type">
                                    <el-select v-model="form.rule_type" placeholder="请选择消费送方式">
                                        <el-option
                                ...
                                <el-form-item label="按比例送" prop="every_rule" v-if="form.rule_type==1">
                                    <div class="ly-flex-style">
                                        <p>消费每满</p>
                                        <el-input v-model="form.every_rule[0].pay_price"></el-input>
                                        <p>元，送</p>
                                        <el-input v-model="form.every_rule[0].give_price"></el-input>
                                        <p>元</p>
                                    </div>
                                </el-form-item>

                                <el-form-item label="按等级送" prop="rule_list" v-if="form.rule_type==2">
                                ...
                                <el-form-item label="百分比送" prop="give_rate" v-if="form.rule_type==3">
                                    <div class="ly-flex-style">
                                        <p>消费百分比</p>
                                        <el-input v-model="form.give_rate"></el-input>
                                        <p>%</p>
                                    </div>
                                </el-form-item>
                                ...
                                <el-form-item label="活动限制" prop="give_times">
                                    <div class="ly-flex-style">
                                        <p>活动期间单个会员消费送次数最多</p>
                                        <el-input v-model="form.give_times" clearable></el-input>
                                        <p>次</p>
                                    </div>
    ...
    export default {
        ...
        data: function () {
            ...
            var checkArrNull = (rule, value, callback) => {
                ...
                let num = 0;
                value.forEach((ele,i)=>{
                    if(!ele.give_price||!ele.pay_price){
                        num ++;
                        console.log('1==========',num);
                        /* callback(new Error('请完善规则(金额保留两位小数)'))*/
                    }
                    else if(!reg.test(ele.give_price)||!reg.test(ele.pay_price)){
                        num ++;
                        console.log('1==========',num);
        ...
        methods: {
            ...
            addRule(val,index){
                ...
                if(this.form.rule_list.length==3){
                    ...
                    this.form.rule_list.splice(index+1,0,{pay_price: "",give_price: "",})
                }
            },
            /**
             * 删除规则
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('此操作将创建新活动，关闭原有活动, 是否继续?', '提示', {
                            ...
                            this.$axios.post('/mer/activy/add/payGift', this.form).then(res => {
